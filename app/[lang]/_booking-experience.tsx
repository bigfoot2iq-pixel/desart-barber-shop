                                ...
                                <div className="px-4 py-3 space-y-3 text-sm">
                                      ...
                                      <div className="space-y-2">
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-2">
                                          ...
                                          <div className="flex items-center gap-1.5 flex-wrap justify-end">
                                            ...
                                            >
                                              {copiedField?.accountId === acct.id && copiedField?.field === "rib" ? tBooking('steps.details.copied') : tBooking('steps.details.copy')}
                                            </button>
                                          </div>
                                        </div>
                                        {acct.iban && (
                                          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-1 sm:gap-2">
                                            ...
                                            <div className="flex items-center gap-1.5 flex-wrap justify-end">
                                              ...
                                              <button
                                                ...
                                                className="min-w-[44px] min-h-[44px] flex items-center justify-center text-[10px] font-semibold uppercase tracking-[0.08em] text-gold hover:text-[rgb(192_154_90/70%)] transition-colors shrink-0 font-mono"
                                              >
                                                {copiedField?.accountId === acct.id && copiedField?.field === "iban" ? tBooking('steps.details.copied') : tBooking('steps.details.copy')}
                                              </button>
                                            </div>
                                          </div>
                                        )}
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <p className="text-xs text-[rgb(10_8_0/55%)] leading-relaxed">
                                      ...
                                      <span className="font-semibold text-brand-black">{paymentConfig.payment_phone ?? tBooking('steps.details.paymentPhoneFallback')}</span>.{" "}
                        ...
                        <div className="flex-1 overflow-y-auto px-1 pt-5 pb-6 text-center">
                          ...
                          {paymentMethod === "bank_transfer" && paymentConfig?.payment_phone && (
                            <p className="text-[12px] text-[rgb(192_154_90/80%)] leading-[1.6] max-w-[320px] mx-auto mb-4 font-medium">
                              {tBooking('steps.confirmation.dontForgetReceipt', { phone: paymentConfig.payment_phone ?? tBooking('steps.details.paymentPhoneFallback') })}
                            </p>
                          )}
