...
import InvitationsManager from '../settings/InvitationsManager';

export const dynamic = 'force-dynamic';

export default async function AdminSettingsPage({ params }: PageProps<'/[lang]'>) {
