...
- Name: booking-time-step.spec.ts >> Booking Time Step — double-book regression >> 12.5 — barber fully booked all day, date not selectable
- Location: __tests__\e2e\booking-time-step.spec.ts:394:7
